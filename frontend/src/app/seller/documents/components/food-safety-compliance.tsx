...
import { ShieldCheck, ClipboardCheck, Edit, Upload } from "lucide-react";
...
export default function FoodSafetyCompliance({
  ...
  // Check if all required fields are complete (Step 3: 2 fields)
  const isComplete = 
    sellerData?.fssaiLicenseNumber?.trim() &&
