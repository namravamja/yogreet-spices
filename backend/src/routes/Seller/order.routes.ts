...
import { updateOrderStatus, getSellerOrders, getSellerOrderById } from "../../controllers/Seller/order.controller";
...
router.get("/:orderId", asyncHandler(getSellerOrderById as any));
